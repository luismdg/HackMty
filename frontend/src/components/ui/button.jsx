export function Button({
    ...
    const variants = {
        default:
            "bg-[#09111E] text-white border border-[#1E293B] hover:bg-[#0C1526] shadow-sm hover:shadow-md",
        destructive:
        ...
        link:
            "underline-offset-4 hover:underline text-[#3B82F6] bg-transparent shadow-none",
    }
